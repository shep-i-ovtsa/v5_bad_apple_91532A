...
void opcontrol(){   
    pros::Task bad(bad_apple::play, &apple, TASK_PRIORITY_DEFAULT, 16384, "BadApple"); //in the link version this will still play but its required to upload a link to your video using the set set_path() function
    ...
    apple.set_path("/usd/bad_apple.txt");
